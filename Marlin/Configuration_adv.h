...
#define ASSISTED_TRAMMING
  ...
  #define TRAMMING_POINT_XY { { 30, 205 }, {  30, 30 }, { 205,  30 }, { 205, 205 } }
...
//#define BEEP_ON_FEEDRATE_CHANGE
  ...
  //#define LED_CONTROL_MENU
    ...
    //#define NEO2_COLOR_PRESETS              // Enable a second NeoPixel Preset Color menu option
      ...
      #define NEO2_USER_PRESET_GREEN        0  // User defined GREEN value
...
// LCD Print Progress options
  ...
  #define MULTI_VOLUME
    ...
    #define VOLUME_SD_LCD
    #define VOLUME_USB_FLASH_DRIVE
    #define DEFAULT_VOLUME SV_USB_FLASH_DRIVE
 ...
 */
  ...
  #if AXIS_IS_TMC(X)
    #define X_CURRENT       1680       // (mA) RMS current. Multiply by 1.414 for peak current.
